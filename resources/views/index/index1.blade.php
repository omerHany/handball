                ...
                <tbody>
                   @foreach ($player as $play )    
                       <tr>
                        ...
                        <td>
                            <div class="m-n1">
                                <a href="{{route('players.edit',$play->id)}}" class="btn btn-sm btn-sm-square btn-outline-primary m-2">
                                    <i class="fas fa-edit"></i>
                                </a>
                               <a href="#" onclick="confirmDistroy('{{$play->id}}',this)" class="btn btn-sm btn-sm-square btn-outline-primary m-2">
