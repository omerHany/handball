            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">تعديل الاداري</h5>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" value="{{$manegar->name}}" id="name"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="number" id="id_number" value="{{$manegar->id_number}}"
                                            class="form-control" placeholder="222555888" aria-label="ACME Inc."
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="number" value="{{$manegar->phone_number}}" id="phone_number"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <select id="job" value="{{$manegar->job}}" class="form-select">
                                            <option>اداري </option>
                                            <option>مدرب</option>
...
<script>
    function performStore() {
            ...
            axios.post('{{route('manegars.update' ,$manegar)}}',
                    formData
                )
